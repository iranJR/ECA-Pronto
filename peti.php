...
if (isset($_REQUEST["act"]) && $_REQUEST["act"] == "save" && $str_month != "" && $str_year != "" && $db_value != "" && $str_situation != "" && $tb_beneficiaries_id_beneficiaries != "" && $tb_city_id_city != ""){
    $peti =  new peti($id, $str_month, $str_year, $db_value, $str_situation, $tb_beneficiaries_id_beneficiaries, $tb_city_id_city);
                ...
                <div class='card'>
                    ...
                    <div class='content table-responsive'>
                        ...
                        <form action="?act=save&id=" method="POST" name="form1">
                            ...
                            ?>"/>
                            Situation:
                            <input class="form-control" type="text" maxlength="14" name="str_situation" value="<?php
                            // Preenche o sigla no campo sigla com um valor "value"
                            echo (isset($str_situation) && ($str_situation != null || $str_situation != "")) ? $str_situation : '';
                            ?>"/>
